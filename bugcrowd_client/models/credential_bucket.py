...
class CredentialBucket(BaseModel):
    """
    CredentialBucket
    """ # noqa: E501
    ...
    attributes: Optional[CredentialBucketAttributes] = None
    relationships: Optional[CredentialBucketRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": CredentialBucketAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": CredentialBucketRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
