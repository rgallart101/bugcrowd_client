...
class ClaimTicket(BaseModel):
    ...
    attributes: Optional[ClaimTicketAttributes] = None
    relationships: Optional[ClaimTicketRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": ClaimTicketAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": ClaimTicketRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
