...
class CreateClaimTicketRequest(BaseModel):
    """
    CreateClaimTicketRequest
    """ # noqa: E501
    data: Optional[CreateClaimTicketRequestData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CreateClaimTicketRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
