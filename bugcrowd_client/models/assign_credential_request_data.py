...
class AssignCredentialRequestData(BaseModel):
    """
    AssignCredentialRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: AssignCredentialRequestDataAttributes
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": AssignCredentialRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
