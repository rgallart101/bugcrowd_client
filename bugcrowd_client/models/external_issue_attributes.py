...
class ExternalIssueAttributes(BaseModel):
    """
    ExternalIssueAttributes
    """ # noqa: E501
    remote_id: Optional[StrictStr] = Field(default=None, description="The identifier for the external issue")
    remote_url: Optional[Any] = Field(default=None, description="URL of the external issue")
    __properties: ClassVar[List[str]] = ["remote_id", "remote_url"]
