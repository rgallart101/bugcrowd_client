...
class ProgramAttributes(BaseModel):
    ...
    ProgramAttributes
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Unique program code, used in the URL")
    name: Optional[StrictStr] = Field(default=None, description="Name of the program")
