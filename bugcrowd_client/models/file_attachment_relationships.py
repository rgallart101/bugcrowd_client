...
class FileAttachmentRelationships(BaseModel):
    """
    FileAttachmentRelationships
    """ # noqa: E501
    parent: Optional[SingleRelationship] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "parent": SingleRelationship.from_dict(obj.get("parent")) if obj.get("parent") is not None else None
        })
        return _obj
