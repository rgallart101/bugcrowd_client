...
class CreateCustomerAssetRequestData(BaseModel):
    """
    CreateCustomerAssetRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CreateCustomerAssetRequestDataAttributes
    relationships: Optional[CreateCustomerAssetRequestDataRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CreateCustomerAssetRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": CreateCustomerAssetRequestDataRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
