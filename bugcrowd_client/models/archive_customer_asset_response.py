...
class ArchiveCustomerAssetResponse(BaseModel):
    """
    ArchiveCustomerAssetResponse
    """ # noqa: E501
    data: Optional[ArchiveCustomerAssetResponseData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ArchiveCustomerAssetResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
