...
class CreateCredentialRequestData(BaseModel):
    """
    CreateCredentialRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: Dict[str, Any]
    relationships: CreateCredentialRequestDataRelationships
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "relationships": CreateCredentialRequestDataRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
