...
class SingleRelationshipLinks(BaseModel):
    """
    SingleRelationshipLinks
    """ # noqa: E501
    related: SingleRelationshipLinksRelated
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "related": SingleRelationshipLinksRelated.from_dict(obj.get("related")) if obj.get("related") is not None else None
        })
        return _obj
