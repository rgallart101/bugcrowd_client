...
class CreateAccessInvitationRequestDataRelationships(BaseModel):
    """
    CreateAccessInvitationRequestDataRelationships
    """ # noqa: E501
    organization: CreateAccessInvitationRequestDataRelationshipsOrganization
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "organization": CreateAccessInvitationRequestDataRelationshipsOrganization.from_dict(obj.get("organization")) if obj.get("organization") is not None else None
        })
        return _obj
