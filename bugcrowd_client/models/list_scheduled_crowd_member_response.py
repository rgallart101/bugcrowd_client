...
class ListScheduledCrowdMemberResponse(BaseModel):
    """
    ListScheduledCrowdMemberResponse
    """ # noqa: E501
    data: Annotated[List[ScheduledCrowdMember], Field(max_length=100)]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [ScheduledCrowdMember.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
