...
class FileAttachment(BaseModel):
    ...
    attributes: Optional[FileAttachmentAttributes] = None
    relationships: Optional[FileAttachmentRelationships] = None
    __properties: ClassVar[List[str]] = ["id", "type", "links", "attributes", "relationships"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('file_attachment'):
            raise ValueError("must be one of enum values ('file_attachment')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": FileAttachmentAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": FileAttachmentRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
