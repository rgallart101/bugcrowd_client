...
class ListSubmissionsResponse(BaseModel):
    ...
    """ # noqa: E501
    links: NavLinks
    data: Annotated[List[Submission], Field(max_length=100)]
    ...
    __properties: ClassVar[List[str]] = ["links", "data", "included", "meta"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": [Submission.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
