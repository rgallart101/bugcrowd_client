...
class ErrorContent(BaseModel):
    ...
    ErrorContent
    """ # noqa: E501
    errors: Annotated[List[ErrorContentErrorsInner], Field(max_length=100)]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "errors": [ErrorContentErrorsInner.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None
        })
        return _obj
