...
class UpdateCredentialRequestDataAttributes(BaseModel):
    """
    UpdateCredentialRequestDataAttributes
    """ # noqa: E501
    state: StrictStr
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('recycle', 'archive'):
            raise ValueError("must be one of enum values ('recycle', 'archive')")
        return value
