...
class Comment(BaseModel):
    ...
    attributes: Optional[CommentAttributes] = None
    relationships: Optional[CommentRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": CommentAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": CommentRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
