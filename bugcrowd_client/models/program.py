...
class Program(BaseModel):
    ...
    attributes: Optional[ProgramAttributes] = None
    relationships: Optional[ProgramRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": ProgramAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": ProgramRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
