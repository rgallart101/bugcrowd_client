...
class MonetaryReward(BaseModel):
    """
    MonetaryReward
    """ # noqa: E501
    ...
    attributes: Optional[MonetaryRewardAttributes] = None
    relationships: Optional[MonetaryRewardRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": MonetaryRewardAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": MonetaryRewardRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
