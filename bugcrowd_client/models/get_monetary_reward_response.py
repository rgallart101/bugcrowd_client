...
class GetMonetaryRewardResponse(BaseModel):
    """
    GetMonetaryRewardResponse
    """ # noqa: E501
    data: MonetaryReward
    included: Optional[Annotated[List[MonetaryRewardIncludedResponseInner], Field(max_length=300)]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": MonetaryReward.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "included": [MonetaryRewardIncludedResponseInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None,
