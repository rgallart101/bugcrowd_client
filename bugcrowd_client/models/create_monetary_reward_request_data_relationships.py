...
class CreateMonetaryRewardRequestDataRelationships(BaseModel):
    """
    CreateMonetaryRewardRequestDataRelationships
    """ # noqa: E501
    submission: SubmissionNotNullable
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "submission": SubmissionNotNullable.from_dict(obj.get("submission")) if obj.get("submission") is not None else None
        })
        return _obj
