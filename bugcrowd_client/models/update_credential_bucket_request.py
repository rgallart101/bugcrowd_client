...
class UpdateCredentialBucketRequest(BaseModel):
    """
    UpdateCredentialBucketRequest
    """ # noqa: E501
    data: UpdateCredentialBucketRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UpdateCredentialBucketRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
