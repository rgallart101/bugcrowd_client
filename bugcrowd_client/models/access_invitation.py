...
class AccessInvitation(BaseModel):
    ...
    attributes: Optional[AccessInvitationAttributes] = None
    relationships: Optional[AccessInvitationRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": AccessInvitationAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": AccessInvitationRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
