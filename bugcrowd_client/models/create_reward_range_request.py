...
class CreateRewardRangeRequest(BaseModel):
    """
    CreateRewardRangeRequest
    """ # noqa: E501
    data: CreateRewardRangeRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CreateRewardRangeRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
