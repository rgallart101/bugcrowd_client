...
class ArchiveCustomerAssetRequest(BaseModel):
    """
    ArchiveCustomerAssetRequest
    """ # noqa: E501
    data: ArchiveCustomerAssetRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ArchiveCustomerAssetRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
