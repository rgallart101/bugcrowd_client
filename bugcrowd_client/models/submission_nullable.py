...
class SubmissionNullable(BaseModel):
    """
    SubmissionNullable
    """ # noqa: E501
    data: Optional[SubmissionNullableData]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": SubmissionNullableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
