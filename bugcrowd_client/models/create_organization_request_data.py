...
class CreateOrganizationRequestData(BaseModel):
    """
    CreateOrganizationRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CreateOrganizationRequestDataAttributes
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CreateOrganizationRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
