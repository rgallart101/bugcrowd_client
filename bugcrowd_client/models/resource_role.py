...
class ResourceRole(BaseModel):
    ...
    attributes: Optional[ResourceRoleAttributes] = None
    relationships: Optional[ResourceRoleRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": ResourceRoleAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": ResourceRoleRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
