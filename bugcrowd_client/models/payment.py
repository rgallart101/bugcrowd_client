...
class Payment(BaseModel):
    ...
    attributes: Optional[PaymentAttributes] = None
    relationships: Optional[PaymentRelationships] = None
    __properties: ClassVar[List[str]] = ["id", "type", "links", "attributes", "relationships"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('payment'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": PaymentAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": PaymentRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
