...
class CredentialBucketRelationships(BaseModel):
    """
    CredentialBucketRelationships
    """ # noqa: E501
    credentials: Optional[ManyRelationship] = None
    bounty: Optional[SingleRelationship] = None
    __properties: ClassVar[List[str]] = ["credentials", "bounty"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of bounty
        if self.bounty:
            _dict['bounty'] = self.bounty.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "bounty": SingleRelationship.from_dict(obj.get("bounty")) if obj.get("bounty") is not None else None
        })
        return _obj
