...
class CreateSubmissionResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Submission
    included: Optional[Annotated[List[CreateSubmissionResponseIncludedInner], Field(max_length=1)]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "included": [CreateSubmissionResponseIncludedInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
