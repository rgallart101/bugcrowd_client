...
class GetProgramBriefResponse(BaseModel):
    """
    GetProgramBriefResponse
    """ # noqa: E501
    data: ProgramBrief
    included: Optional[Annotated[List[ProgramBriefIncludedResponseInner], Field(max_length=200)]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": ProgramBrief.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "included": [ProgramBriefIncludedResponseInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None,
