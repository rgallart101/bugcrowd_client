...
class CreateSubmissionRequestDataRelationships(BaseModel):
    """
    CreateSubmissionRequestDataRelationships
    """ # noqa: E501
    program: ProgramNotNullable
    target: Optional[TargetNotNullable] = None
    __properties: ClassVar[List[str]] = ["program", "target"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "program": ProgramNotNullable.from_dict(obj.get("program")) if obj.get("program") is not None else None,
            "target": TargetNotNullable.from_dict(obj.get("target")) if obj.get("target") is not None else None
        })
        return _obj
