...
class CreateIdentityRequestData(BaseModel):
    """
    CreateIdentityRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CreateIdentityRequestDataAttributes
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CreateIdentityRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
