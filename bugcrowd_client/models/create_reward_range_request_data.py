...
class CreateRewardRangeRequestData(BaseModel):
    """
    CreateRewardRangeRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CreateRewardRangeRequestDataAttributes
    __properties: ClassVar[List[str]] = ["type", "attributes"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('reward_range'):
            raise ValueError("must be one of enum values ('reward_range')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CreateRewardRangeRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
