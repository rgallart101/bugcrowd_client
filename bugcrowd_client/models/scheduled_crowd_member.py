...
class ScheduledCrowdMember(BaseModel):
    """
    ...
    attributes: Optional[ScheduledCrowdMemberAttributes] = None
    relationships: Optional[ScheduledCrowdMemberRelationships] = None
    __properties: ClassVar[List[str]] = ["id", "type", "links", "attributes", "relationships"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('scheduled_crowd_member'):
            raise ValueError("must be one of enum values ('scheduled_crowd_member')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": ScheduledCrowdMemberAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": ScheduledCrowdMemberRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
