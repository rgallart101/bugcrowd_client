...
class ProgramBrief(BaseModel):
    ...
    attributes: Optional[ProgramBriefAttributes] = None
    relationships: Optional[ProgramBriefRelationships] = None
    __properties: ClassVar[List[str]] = ["id", "type", "links", "attributes", "relationships"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('program_brief'):
            raise ValueError("must be one of enum values ('program_brief')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": ProgramBriefAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": ProgramBriefRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
