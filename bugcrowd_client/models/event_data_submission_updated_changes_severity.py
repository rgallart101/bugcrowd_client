...
class EventDataSubmissionUpdatedChangesSeverity(BaseModel):
    """
    EventDataSubmissionUpdatedChangesSeverity
    """ # noqa: E501
    var_from: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = Field(default=None, alias="from")
    to: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = None
