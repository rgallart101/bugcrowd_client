...
class WebhookSubmissionCreatedEventRelationshipsActor(BaseModel):
    """
    WebhookSubmissionCreatedEventRelationshipsActor
    """ # noqa: E501
    data: EventRelationshipsActorData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EventRelationshipsActorData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
