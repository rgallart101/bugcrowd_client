...
class CreateCustomerAssetRequestDataRelationships(BaseModel):
    """
    CreateCustomerAssetRequestDataRelationships
    """ # noqa: E501
    organization: OrganizationNotNullable
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "organization": OrganizationNotNullable.from_dict(obj.get("organization")) if obj.get("organization") is not None else None
        })
        return _obj
