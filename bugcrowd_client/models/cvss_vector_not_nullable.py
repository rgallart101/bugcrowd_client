...
class CvssVectorNotNullable(BaseModel):
    """
    CvssVectorNotNullable
    """ # noqa: E501
    data: CvssVectorNotNullableData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CvssVectorNotNullableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
