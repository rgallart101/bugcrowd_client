...
class EventDataSubmissionUpdated(BaseModel):
    """
    submission.updated
    """ # noqa: E501
    changes: EventDataSubmissionUpdatedChanges
    duplicate_ids: List[StrictStr]
    __properties: ClassVar[List[str]] = ["changes", "duplicate_ids"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "changes": EventDataSubmissionUpdatedChanges.from_dict(obj.get("changes")) if obj.get("changes") is not None else None,
            "duplicate_ids": obj.get("duplicate_ids")
        })
        return _obj
