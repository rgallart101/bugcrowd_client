...
class SubmissionNotNullable(BaseModel):
    """
    SubmissionNotNullable
    """ # noqa: E501
    data: SubmissionsMax1DataInner
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": SubmissionsMax1DataInner.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
