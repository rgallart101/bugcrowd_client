...
class PaymentRelationships(BaseModel):
    """
    PaymentRelationships
    """ # noqa: E501
    monetary_reward: Optional[SingleRelationship] = None
    researcher: Optional[SingleRelationship] = None
    __properties: ClassVar[List[str]] = ["monetary_reward", "researcher"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of monetary_reward
        if self.monetary_reward:
            _dict['monetary_reward'] = self.monetary_reward.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "monetary_reward": SingleRelationship.from_dict(obj.get("monetary_reward")) if obj.get("monetary_reward") is not None else None,
