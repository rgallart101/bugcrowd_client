...
class AccessInvitationAttributes(BaseModel):
    """
    AccessInvitationAttributes
    """ # noqa: E501
    approved_at: Optional[datetime] = None
    created_at: Optional[datetime] = None
    grantee_email: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["approved_at", "created_at", "grantee_email"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "grantee_email": obj.get("grantee_email")
        })
        return _obj
