...
class ScheduledCrowdMemberRelationships(BaseModel):
    """
    ScheduledCrowdMemberRelationships
    """ # noqa: E501
    user: Optional[SingleRelationship] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "user": SingleRelationship.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
