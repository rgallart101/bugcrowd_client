...
class ManyRelationshipLinks(BaseModel):
    """
    ManyRelationshipLinks
    """ # noqa: E501
    related: ManyRelationshipLinksRelated
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "related": ManyRelationshipLinksRelated.from_dict(obj.get("related")) if obj.get("related") is not None else None
        })
        return _obj
