...
class CvssVector(BaseModel):
    ...
    attributes: Optional[CvssVectorAttributes] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('cvss_vector'):
            raise ValueError("must be one of enum values ('cvss_vector')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": CvssVectorAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
