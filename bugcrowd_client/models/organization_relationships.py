...
class OrganizationRelationships(BaseModel):
    ...
    programs: Optional[ManyRelationship] = None
    __properties: ClassVar[List[str]] = ["targets", "programs"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "programs": ManyRelationship.from_dict(obj.get("programs")) if obj.get("programs") is not None else None
        })
        return _obj
