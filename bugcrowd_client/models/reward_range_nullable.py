...
class RewardRangeNullable(BaseModel):
    """
    RewardRangeNullable
    """ # noqa: E501
    data: Optional[RewardRangeNullableData]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": RewardRangeNullableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
