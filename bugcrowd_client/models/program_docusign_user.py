...
class ProgramDocusignUser(BaseModel):
    """
    ProgramDocusignUser
    """ # noqa: E501
    ...
    attributes: Optional[ProgramDocusignUserAttributes] = None
    __properties: ClassVar[List[str]] = ["id", "type", "links", "attributes"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('program_docusign_user'):
            raise ValueError("must be one of enum values ('program_docusign_user')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": ProgramDocusignUserAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
