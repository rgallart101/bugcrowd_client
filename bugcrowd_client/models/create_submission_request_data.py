...
class CreateSubmissionRequestData(BaseModel):
    """
    CreateSubmissionRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CreateSubmissionRequestDataAttributes
    relationships: CreateSubmissionRequestDataRelationships
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CreateSubmissionRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": CreateSubmissionRequestDataRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
