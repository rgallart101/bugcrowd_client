...
class CreateCredentialBucketRequest(BaseModel):
    """
    CreateCredentialBucketRequest
    """ # noqa: E501
    data: CreateCredentialBucketRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CreateCredentialBucketRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
