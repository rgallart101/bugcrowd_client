...
class CreateTargetRequestData(BaseModel):
    """
    CreateTargetRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CreateTargetRequestDataAttributes
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('target'):
            raise ValueError("must be one of enum values ('target')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CreateTargetRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
