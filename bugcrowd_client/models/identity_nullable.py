...
class IdentityNullable(BaseModel):
    """
    IdentityNullable
    """ # noqa: E501
    data: Optional[IdentityNullableData]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": IdentityNullableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
