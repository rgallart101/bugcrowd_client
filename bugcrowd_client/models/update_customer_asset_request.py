...
class UpdateCustomerAssetRequest(BaseModel):
    """
    UpdateCustomerAssetRequest
    """ # noqa: E501
    data: UpdateCustomerAssetRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UpdateCustomerAssetRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
