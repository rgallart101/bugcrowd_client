...
class EventRelationshipsResource(BaseModel):
    """
    EventRelationshipsResource
    """ # noqa: E501
    data: EventRelationshipsResourceData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": EventRelationshipsResourceData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
