...
class Target(BaseModel):
    ...
    attributes: Optional[TargetAttributes] = None
    relationships: Optional[TargetRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": TargetAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": TargetRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
