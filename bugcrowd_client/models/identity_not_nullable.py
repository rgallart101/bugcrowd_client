...
class IdentityNotNullable(BaseModel):
    """
    IdentityNotNullable
    """ # noqa: E501
    data: IdentityNotNullableData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": IdentityNotNullableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
