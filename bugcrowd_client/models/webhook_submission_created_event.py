...
class WebhookSubmissionCreatedEvent(BaseModel):
    """
    WebhookSubmissionCreatedEvent
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the resource")
    type: StrictStr
    attributes: WebhookSubmissionCreatedEventAttributes
    relationships: WebhookSubmissionCreatedEventRelationships
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": WebhookSubmissionCreatedEventAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": WebhookSubmissionCreatedEventRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None,
