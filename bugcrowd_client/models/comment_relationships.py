...
class CommentRelationships(BaseModel):
    ...
    """ # noqa: E501
    author: Optional[SingleRelationship] = None
    file_attachments: Optional[ManyRelationship] = None
    __properties: ClassVar[List[str]] = ["author", "file_attachments"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "author": SingleRelationship.from_dict(obj.get("author")) if obj.get("author") is not None else None,
