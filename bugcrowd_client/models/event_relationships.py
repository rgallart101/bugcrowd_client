...
class EventRelationships(BaseModel):
    ...
    EventRelationships
    """ # noqa: E501
    actor: EventRelationshipsActor
    resource: EventRelationshipsResource
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "actor": EventRelationshipsActor.from_dict(obj.get("actor")) if obj.get("actor") is not None else None,
            "resource": EventRelationshipsResource.from_dict(obj.get("resource")) if obj.get("resource") is not None else None
        })
        return _obj
