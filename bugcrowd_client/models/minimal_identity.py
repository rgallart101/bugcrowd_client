...
class MinimalIdentity(BaseModel):
    """
    MinimalIdentity
    """ # noqa: E501
    ...
    type: StrictStr
    links: SelfLink
    attributes: Optional[MinimalIdentityAttributes] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": MinimalIdentityAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
