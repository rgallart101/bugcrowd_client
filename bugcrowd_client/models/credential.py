...
class Credential(BaseModel):
    ...
    Credential
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the resource")
    type: StrictStr
    links: Optional[SelfLink] = None
    attributes: Optional[CredentialAttributes] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('credential'):
            raise ValueError("must be one of enum values ('credential')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": CredentialAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
