...
class CreateAccessInvitationRequestIncludedInnerRelationshipsResourceData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('organization', 'program'):
            raise ValueError("must be one of enum values ('organization', 'program')")
        return value
