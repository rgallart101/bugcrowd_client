...
class CreateCommentRequestData(BaseModel):
    """
    CreateCommentRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CreateCommentRequestDataAttributes
    relationships: CreateCommentRequestDataRelationships
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CreateCommentRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": CreateCommentRequestDataRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
