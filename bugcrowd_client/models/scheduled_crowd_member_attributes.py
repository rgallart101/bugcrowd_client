...
class ScheduledCrowdMemberAttributes(BaseModel):
    """
    ScheduledCrowdMemberAttributes
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the scheduled crowd member")
    accepted_at: Optional[datetime] = Field(default=None, description="Time at which the invitation was accepted")
    __properties: ClassVar[List[str]] = ["id", "accepted_at"]
