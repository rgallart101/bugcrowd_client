...
class RewardRange(BaseModel):
    ...
    attributes: Optional[RewardRangeAttributes] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": RewardRangeAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
