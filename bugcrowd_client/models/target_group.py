...
class TargetGroup(BaseModel):
    ...
    relationships: Optional[TargetGroupRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": TargetGroupAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": TargetGroupRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
