...
class CredentialBucketNotNullable(BaseModel):
    """
    CredentialBucketNotNullable
    """ # noqa: E501
    data: CredentialBucketNotNullableData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CredentialBucketNotNullableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
