...
class UpdateCredentialRequestData(BaseModel):
    """
    UpdateCredentialRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: UpdateCredentialRequestDataAttributes
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": UpdateCredentialRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
