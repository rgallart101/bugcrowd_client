...
class OrganizationNotNullable(BaseModel):
    """
    OrganizationNotNullable
    """ # noqa: E501
    data: OrganizationNotNullableData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrganizationNotNullableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
