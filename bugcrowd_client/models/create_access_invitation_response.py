...
class CreateAccessInvitationResponse(BaseModel):
    """
    CreateAccessInvitationResponse
    """ # noqa: E501
    data: AccessInvitation
    included: List[ResourceRole]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": AccessInvitation.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "included": [ResourceRole.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
