...
class UpdateMonetaryRewardRequest(BaseModel):
    """
    UpdateMonetaryRewardRequest
    """ # noqa: E501
    data: UpdateMonetaryRewardRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UpdateMonetaryRewardRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
