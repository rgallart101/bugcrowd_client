...
class CustomerAssetRelationships(BaseModel):
    """
    CustomerAssetRelationships
    """ # noqa: E501
    created_by: Optional[SingleRelationship] = None
    last_modified_by: Optional[SingleRelationship] = None
    organization: Optional[SingleRelationship] = None
    __properties: ClassVar[List[str]] = ["created_by", "last_modified_by", "organization"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "created_by": SingleRelationship.from_dict(obj.get("created_by")) if obj.get("created_by") is not None else None,
            "last_modified_by": SingleRelationship.from_dict(obj.get("last_modified_by")) if obj.get("last_modified_by") is not None else None,
