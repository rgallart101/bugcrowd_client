...
class Submission(BaseModel):
    ...
    attributes: Optional[SubmissionAttributes] = None
    relationships: Optional[SubmissionRelationships] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": SubmissionAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
            "relationships": SubmissionRelationships.from_dict(obj.get("relationships")) if obj.get("relationships") is not None else None
        })
        return _obj
