...
class UpdateExternalIssueRequest(BaseModel):
    """
    UpdateExternalIssueRequest
    """ # noqa: E501
    data: UpdateExternalIssueRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": UpdateExternalIssueRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
