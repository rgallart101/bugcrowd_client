...
class ListCredentialBucketResponse(BaseModel):
    """
    ListCredentialBucketResponse
    """ # noqa: E501
    data: Annotated[List[CredentialBucket], Field(max_length=100)]
    included: Optional[Annotated[List[Credential], Field(max_length=100)]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [CredentialBucket.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "included": [Credential.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None
        })
        return _obj
