...
class CreateMonetaryRewardRequest(BaseModel):
    """
    CreateMonetaryRewardRequest
    """ # noqa: E501
    data: CreateMonetaryRewardRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CreateMonetaryRewardRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
