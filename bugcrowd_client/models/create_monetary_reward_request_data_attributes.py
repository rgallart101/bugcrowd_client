...
class CreateMonetaryRewardRequestDataAttributes(BaseModel):
    """
    CreateMonetaryRewardRequestDataAttributes
    """ # noqa: E501
    amount_cents: Annotated[int, Field(strict=True, ge=1)]
    comment: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["amount_cents", "comment"]
