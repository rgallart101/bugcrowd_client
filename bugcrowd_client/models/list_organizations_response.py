...
class ListOrganizationsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Annotated[List[Organization], Field(max_length=100)]
    included: Optional[Annotated[List[OrganizationIncludedResponseInner], Field(max_length=200)]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [Organization.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "included": [OrganizationIncludedResponseInner.from_dict(_item) for _item in obj.get("included")] if obj.get("included") is not None else None,
