...
class UpdateCustomerAssetRequestDataRelationships(BaseModel):
    """
    UpdateCustomerAssetRequestDataRelationships
    """ # noqa: E501
    organization: OrganizationNullable
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "organization": OrganizationNullable.from_dict(obj.get("organization")) if obj.get("organization") is not None else None
        })
        return _obj
