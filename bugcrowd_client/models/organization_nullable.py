...
class OrganizationNullable(BaseModel):
    """
    OrganizationNullable
    """ # noqa: E501
    data: Optional[OrganizationNullableData]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": OrganizationNullableData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
