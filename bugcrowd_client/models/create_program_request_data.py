...
class CreateProgramRequestData(BaseModel):
    """
    CreateProgramRequestData
    """ # noqa: E501
    type: StrictStr
    attributes: CreateProgramRequestDataAttributes
    relationships: CreateCustomerAssetRequestDataRelationships
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('program'):
            raise ValueError("must be one of enum values ('program')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CreateProgramRequestDataAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None,
