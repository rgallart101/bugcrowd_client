...
class CreateCustomerAssetRequest(BaseModel):
    """
    CreateCustomerAssetRequest
    """ # noqa: E501
    data: CreateCustomerAssetRequestData
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": CreateCustomerAssetRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
