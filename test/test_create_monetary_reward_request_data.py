...
class TestCreateMonetaryRewardRequestData(unittest.TestCase):
    """CreateMonetaryRewardRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMonetaryRewardRequestData:
        """Test CreateMonetaryRewardRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateMonetaryRewardRequestData`
        """
        model = CreateMonetaryRewardRequestData()
        if include_optional:
            return CreateMonetaryRewardRequestData(
    ...
    def testCreateMonetaryRewardRequestData(self):
        """Test CreateMonetaryRewardRequestData"""
