...
class TestTargetRelationships(unittest.TestCase):
    """TargetRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TargetRelationships:
        """Test TargetRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TargetRelationships`
        """
        model = TargetRelationships()
        if include_optional:
    ...
    def testTargetRelationships(self):
        """Test TargetRelationships"""
