...
class TestWebhookSubmissionCreatedRequestIncludedInner(unittest.TestCase):
    """WebhookSubmissionCreatedRequestIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookSubmissionCreatedRequestIncludedInner:
        """Test WebhookSubmissionCreatedRequestIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookSubmissionCreatedRequestIncludedInner`
        """
        model = WebhookSubmissionCreatedRequestIncludedInner()
        if include_optional:
            return WebhookSubmissionCreatedRequestIncludedInner(
                id = '',
                type = 'identity',
    ...
    def testWebhookSubmissionCreatedRequestIncludedInner(self):
        """Test WebhookSubmissionCreatedRequestIncludedInner"""
