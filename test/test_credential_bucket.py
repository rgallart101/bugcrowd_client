...
class TestCredentialBucket(unittest.TestCase):
    """CredentialBucket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialBucket:
        """Test CredentialBucket
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialBucket`
        """
        model = CredentialBucket()
        if include_optional:
