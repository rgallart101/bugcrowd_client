...
class TestProgramIncludedResponseInner(unittest.TestCase):
    """ProgramIncludedResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgramIncludedResponseInner:
        """Test ProgramIncludedResponseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgramIncludedResponseInner`
        """
        model = ProgramIncludedResponseInner()
        if include_optional:
            return ProgramIncludedResponseInner(
                id = '',
                type = 'program_brief',
    ...
    def testProgramIncludedResponseInner(self):
        """Test ProgramIncludedResponseInner"""
