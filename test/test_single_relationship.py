...
class TestSingleRelationship(unittest.TestCase):
    """SingleRelationship unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleRelationship:
        """Test SingleRelationship
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleRelationship`
        """
        model = SingleRelationship()
        if include_optional:
    ...
    def testSingleRelationship(self):
        """Test SingleRelationship"""
