...
class TestMonetaryReward(unittest.TestCase):
    """MonetaryReward unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonetaryReward:
        """Test MonetaryReward
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonetaryReward`
        """
        model = MonetaryReward()
        if include_optional:
