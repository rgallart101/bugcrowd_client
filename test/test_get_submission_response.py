...
class TestGetSubmissionResponse(unittest.TestCase):
    """GetSubmissionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSubmissionResponse:
        """Test GetSubmissionResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSubmissionResponse`
        """
    ...
    def testGetSubmissionResponse(self):
        """Test GetSubmissionResponse"""
