...
class TestEventDataSubmissionUpdated(unittest.TestCase):
    """EventDataSubmissionUpdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventDataSubmissionUpdated:
        """Test EventDataSubmissionUpdated
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventDataSubmissionUpdated`
        """
        model = EventDataSubmissionUpdated()
        if include_optional:
            return EventDataSubmissionUpdated(
    ...
    def testEventDataSubmissionUpdated(self):
        """Test EventDataSubmissionUpdated"""
