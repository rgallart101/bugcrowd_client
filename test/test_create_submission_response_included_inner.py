...
class TestCreateSubmissionResponseIncludedInner(unittest.TestCase):
    """CreateSubmissionResponseIncludedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSubmissionResponseIncludedInner:
        """Test CreateSubmissionResponseIncludedInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSubmissionResponseIncludedInner`
        """
        model = CreateSubmissionResponseIncludedInner()
        if include_optional:
            return CreateSubmissionResponseIncludedInner(
                id = '',
                type = 'claim_ticket',
    ...
    def testCreateSubmissionResponseIncludedInner(self):
        """Test CreateSubmissionResponseIncludedInner"""
