...
class TestCommentRelationships(unittest.TestCase):
    """CommentRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentRelationships:
        """Test CommentRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentRelationships`
        """
        model = CommentRelationships()
        if include_optional:
    ...
    def testCommentRelationships(self):
        """Test CommentRelationships"""
