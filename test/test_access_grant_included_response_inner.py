...
class TestAccessGrantIncludedResponseInner(unittest.TestCase):
    """AccessGrantIncludedResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessGrantIncludedResponseInner:
        """Test AccessGrantIncludedResponseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessGrantIncludedResponseInner`
        """
        model = AccessGrantIncludedResponseInner()
        if include_optional:
            return AccessGrantIncludedResponseInner(
                id = '',
                type = 'identity',
    ...
    def testAccessGrantIncludedResponseInner(self):
        """Test AccessGrantIncludedResponseInner"""
