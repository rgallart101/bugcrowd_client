...
class TestOrganizationRelationships(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrganizationRelationships:
        """Test OrganizationRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationRelationships`
        """
        model = OrganizationRelationships()
        if include_optional:
