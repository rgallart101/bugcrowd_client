...
class TestListCredentialBucketResponse(unittest.TestCase):
    """ListCredentialBucketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCredentialBucketResponse:
        """Test ListCredentialBucketResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCredentialBucketResponse`
        """
        model = ListCredentialBucketResponse()
        if include_optional:
            return ListCredentialBucketResponse(
                data = [
                    bugcrowd_client.models.credential_bucket.CredentialBucket(
                        id = '', 
    ...
    def testListCredentialBucketResponse(self):
        """Test ListCredentialBucketResponse"""
