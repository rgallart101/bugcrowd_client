...
class TestListAccessGrantsResponse(unittest.TestCase):
    """ListAccessGrantsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAccessGrantsResponse:
        """Test ListAccessGrantsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAccessGrantsResponse`
        """
        model = ListAccessGrantsResponse()
        if include_optional:
            return ListAccessGrantsResponse(
                data = [
                    bugcrowd_client.models.access_grant.AccessGrant(
                        id = '', 
                        type = 'access_grant', 
    ...
    def testListAccessGrantsResponse(self):
        """Test ListAccessGrantsResponse"""
