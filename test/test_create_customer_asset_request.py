...
class TestCreateCustomerAssetRequest(unittest.TestCase):
    """CreateCustomerAssetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCustomerAssetRequest:
        """Test CreateCustomerAssetRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCustomerAssetRequest`
        """
        model = CreateCustomerAssetRequest()
        if include_optional:
            return CreateCustomerAssetRequest(
                data = bugcrowd_client.models.create_customer_asset_request_data.CreateCustomerAssetRequest_data(
                    type = 'customer_asset', 
    ...
    def testCreateCustomerAssetRequest(self):
        """Test CreateCustomerAssetRequest"""
