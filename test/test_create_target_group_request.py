...
class TestCreateTargetGroupRequest(unittest.TestCase):
    """CreateTargetGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTargetGroupRequest:
        """Test CreateTargetGroupRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTargetGroupRequest`
        """
        model = CreateTargetGroupRequest()
        if include_optional:
            return CreateTargetGroupRequest(
                data = bugcrowd_client.models.create_target_group_request_data.CreateTargetGroupRequest_data(
                    type = 'target_group', 
    ...
    def testCreateTargetGroupRequest(self):
        """Test CreateTargetGroupRequest"""
