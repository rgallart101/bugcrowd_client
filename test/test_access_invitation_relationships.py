...
class TestAccessInvitationRelationships(unittest.TestCase):
    """AccessInvitationRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessInvitationRelationships:
        """Test AccessInvitationRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessInvitationRelationships`
        """
        model = AccessInvitationRelationships()
        if include_optional:
            return AccessInvitationRelationships(
    ...
    def testAccessInvitationRelationships(self):
        """Test AccessInvitationRelationships"""
