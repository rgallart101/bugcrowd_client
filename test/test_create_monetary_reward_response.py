...
class TestCreateMonetaryRewardResponse(unittest.TestCase):
    """CreateMonetaryRewardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMonetaryRewardResponse:
        """Test CreateMonetaryRewardResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateMonetaryRewardResponse`
        """
        model = CreateMonetaryRewardResponse()
        if include_optional:
            return CreateMonetaryRewardResponse(
    ...
    def testCreateMonetaryRewardResponse(self):
        """Test CreateMonetaryRewardResponse"""
