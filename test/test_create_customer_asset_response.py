...
class TestCreateCustomerAssetResponse(unittest.TestCase):
    """CreateCustomerAssetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCustomerAssetResponse:
        """Test CreateCustomerAssetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCustomerAssetResponse`
        """
        model = CreateCustomerAssetResponse()
        if include_optional:
            return CreateCustomerAssetResponse(
    ...
    def testCreateCustomerAssetResponse(self):
        """Test CreateCustomerAssetResponse"""
