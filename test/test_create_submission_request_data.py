...
class TestCreateSubmissionRequestData(unittest.TestCase):
    """CreateSubmissionRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSubmissionRequestData:
        """Test CreateSubmissionRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSubmissionRequestData`
        """
        model = CreateSubmissionRequestData()
        if include_optional:
            return CreateSubmissionRequestData(
                type = 'submission',
    ...
    def testCreateSubmissionRequestData(self):
        """Test CreateSubmissionRequestData"""
