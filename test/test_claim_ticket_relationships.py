...
class TestClaimTicketRelationships(unittest.TestCase):
    """ClaimTicketRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClaimTicketRelationships:
        """Test ClaimTicketRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClaimTicketRelationships`
        """
        model = ClaimTicketRelationships()
        if include_optional:
            return ClaimTicketRelationships(
    ...
    def testClaimTicketRelationships(self):
        """Test ClaimTicketRelationships"""
