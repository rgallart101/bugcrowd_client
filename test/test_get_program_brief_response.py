...
class TestGetProgramBriefResponse(unittest.TestCase):
    """GetProgramBriefResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetProgramBriefResponse:
        """Test GetProgramBriefResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetProgramBriefResponse`
        """
        model = GetProgramBriefResponse()
        if include_optional:
            return GetProgramBriefResponse(
                data = bugcrowd_client.models.program_brief.ProgramBrief(
                    id = '', 
                    type = 'program_brief', 
    ...
    def testGetProgramBriefResponse(self):
        """Test GetProgramBriefResponse"""
