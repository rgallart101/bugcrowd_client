...
class TestListExternalIssueResponse(unittest.TestCase):
    """ListExternalIssueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListExternalIssueResponse:
        """Test ListExternalIssueResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListExternalIssueResponse`
        """
        model = ListExternalIssueResponse()
        if include_optional:
            return ListExternalIssueResponse(
                data = [
    ...
    def testListExternalIssueResponse(self):
        """Test ListExternalIssueResponse"""
