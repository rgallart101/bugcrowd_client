...
class TestCredentialBucketResponse(unittest.TestCase):
    """CredentialBucketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialBucketResponse:
        """Test CredentialBucketResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialBucketResponse`
        """
        model = CredentialBucketResponse()
        if include_optional:
            return CredentialBucketResponse(
    ...
    def testCredentialBucketResponse(self):
        """Test CredentialBucketResponse"""
