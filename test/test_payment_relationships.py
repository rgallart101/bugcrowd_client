...
class TestPaymentRelationships(unittest.TestCase):
    """PaymentRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentRelationships:
        """Test PaymentRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentRelationships`
        """
        model = PaymentRelationships()
        if include_optional:
    ...
    def testPaymentRelationships(self):
        """Test PaymentRelationships"""
