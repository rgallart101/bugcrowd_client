...
class TestListAccessInvitationsResponse(unittest.TestCase):
    """ListAccessInvitationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAccessInvitationsResponse:
        """Test ListAccessInvitationsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAccessInvitationsResponse`
        """
        model = ListAccessInvitationsResponse()
        if include_optional:
            return ListAccessInvitationsResponse(
                data = [
                    bugcrowd_client.models.access_invitation.AccessInvitation(
                        id = '', 
    ...
    def testListAccessInvitationsResponse(self):
        """Test ListAccessInvitationsResponse"""
