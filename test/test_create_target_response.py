...
class TestCreateTargetResponse(unittest.TestCase):
    """CreateTargetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTargetResponse:
        """Test CreateTargetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTargetResponse`
        """
        model = CreateTargetResponse()
        if include_optional:
            return CreateTargetResponse(
                data = bugcrowd_client.models.target.Target(
                    id = '', 
                    type = 'target', 
    ...
    def testCreateTargetResponse(self):
        """Test CreateTargetResponse"""
