...
class TestCreateClaimTicketResponse(unittest.TestCase):
    """CreateClaimTicketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateClaimTicketResponse:
        """Test CreateClaimTicketResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateClaimTicketResponse`
        """
        model = CreateClaimTicketResponse()
        if include_optional:
            return CreateClaimTicketResponse(
                data = bugcrowd_client.models.claim_ticket.ClaimTicket(
                    id = '', 
                    type = 'claim_ticket', 
    ...
    def testCreateClaimTicketResponse(self):
        """Test CreateClaimTicketResponse"""
