...
class TestGetExternalIssueResponse(unittest.TestCase):
    """GetExternalIssueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExternalIssueResponse:
        """Test GetExternalIssueResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExternalIssueResponse`
        """
        model = GetExternalIssueResponse()
        if include_optional:
            return GetExternalIssueResponse(
    ...
    def testGetExternalIssueResponse(self):
        """Test GetExternalIssueResponse"""
