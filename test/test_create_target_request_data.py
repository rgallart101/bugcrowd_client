...
class TestCreateTargetRequestData(unittest.TestCase):
    """CreateTargetRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTargetRequestData:
        """Test CreateTargetRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTargetRequestData`
        """
        model = CreateTargetRequestData()
        if include_optional:
            return CreateTargetRequestData(
                type = 'target',
    ...
    def testCreateTargetRequestData(self):
        """Test CreateTargetRequestData"""
